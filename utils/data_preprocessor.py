...
def construct_hdf5(data_parameters, file_information):
...
def write_hdf5(input_volumes, target_labels, target_ages, file_information, mode):
...
def load_datasets(subjects, data_directory, input_file, modality_flag, test_age_labels, test_ages):
...
def load_and_preprocess(subject, index, data_directory, input_file, modality_flag, test_age_labels, test_ages):
...
def load_data(subject, index, data_directory, input_file, test_age_labels, test_ages):
...
def preprocess(input_volume, modality_flag):
